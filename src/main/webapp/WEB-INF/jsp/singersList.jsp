...
<c:forEach items="${SingersList}" var="singer">
    <tr>
        <td>${singer.user.lastName}</td>
        <td>${singer.user.firstName}</td>
        <td>${singer.user.username}</td>
        <td>${singer.schedule.time}</td>
        <td>${singer.schedule.date}</td>
        <td>${singer.stage.stageId}</td>
        <td>${singer.stage.genre}</td>
    </tr>
</c:forEach>
    </table>
</body>
